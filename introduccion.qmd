...
LaTeX es un conjunto de macros para TeX debido originalmente a [Leslie Lamport](https://en.wikipedia.org/wiki/Leslie_Lamport) para facilitar la composición de documentos científicos y técnicos.
