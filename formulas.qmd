...
## Sumatorios, productorios, integrales y límites.
...
Finalmente, para escribir límites se utiliza el comando `\lim_{sub}`, donde `sub` es el subíndice e indica las variables y el valor al que tienden.
