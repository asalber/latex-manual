...
\section{¿Qué es TeX?}\label{quuxe9-es-tex}
...
\section{¿Qué es LaTeX?}\label{quuxe9-es-latex}

\pandocbounded{\includegraphics[keepaspectratio]{img/logos/latex-project-logo.png}}
...
facilitar la composición de documentos científicos y técnicos.

Tanto TeX como LaTeX son programas de código abierto, liberados bajo la
...
un documento en LaTeX, a continuación se explica brevemente el contenido
de este fichero:
...
\item
  La cuarta línea contiene el texto del documento. \texttt{LaTeX} es un
  comando que produce la salida LaTeX.
\item
...
\pandocbounded{\includegraphics[keepaspectratio]{img/introduccion/overleaf-hola-latex.png}}
...
Si en el documento anterior cambiamos el comando \texttt{LaTeX} por otro
que no existe, por ejemplo \texttt{\textbackslash{}error}, al compilar
el documento tendremos el siguiente error.
...
\pandocbounded{\includegraphics[keepaspectratio]{img/estructura/overleaf-documento-base.png}}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title={Salida}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

\pandocbounded{\includegraphics[keepaspectratio]{img/secciones/secciones.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/secciones/parrafos.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/secciones/justificacion.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formateo/resaltado.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formateo/tipos-letra.png}}
...
\begin{example}[]\protect\hypertarget{exm-familias-letra-xelatex}{}\label{exm-familias-letra-xelatex}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formateo/tipos-letra-xelatex.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formateo/perfiles-letra.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formateo/tamaño-fuente.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/listas/lista-no-ordenad.png}}

\end{tcolorbox}

\end{example}

\begin{example}[]\protect\hypertarget{exm-lista-ordenada}{}\label{exm-lista-ordenada}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/listas/lista-ordenada.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/listas/lista-desciptiva.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/listas/listas-anidadas.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/tablas/tabla-simple.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/tablas/tabla-delimitada.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/tablas/tabla-multicolumna.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/imagenes/imganes.png}}
...
LaTeX, y es por ello que se utiliza tanto para la creación de documentos
científicos o técnicos con contenido matemático.
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/entornos-matematicos.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/indices.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/fracciones.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/sumatorio.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/integral.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/limite.png}}
...
\begin{example}[]\protect\hypertarget{exm-sombreros}{}\label{exm-sombreros}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/sombreros.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/matriz.png}}
...
\begin{example}[]\protect\hypertarget{exm-entornos-matrices}{}\label{exm-entornos-matrices}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/determinante.png}}
...
\begin{example}[]\protect\hypertarget{exm-teoremas}{}\label{exm-teoremas}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/formulas/teoremas.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/entornos-flotantes/figura-flotante.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/entornos-flotantes/tabla-flotante.png}}
...
\begin{example}[]\protect\hypertarget{exm-referencias-cruzadas}{}\label{exm-referencias-cruzadas}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/referencias-cruzadas/referencias-cruzadas.png}}
...
\CommentTok{\% CUERPO}
\KeywordTok{\textbackslash{}begin}\NormalTok{\{}\ExtensionTok{document}\NormalTok{\}}
\NormalTok{El logotipo de latex es LaTeX.}\FunctionTok{\textbackslash{}footnote}\NormalTok{\{Fue creado por Leslie Lamport.\}}
\KeywordTok{\textbackslash{}end}\NormalTok{\{}\ExtensionTok{document}\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/referencias-cruzadas/nota-pie.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/bibliografia/bibliografia.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/bibliografia/bibliografia2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/diseño-pagina/pagina-a5-apaisada.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/diseño-pagina/pagina-margenes-personalizados.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/diseño-pagina/encabezado-pie.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{img/diseño-pagina/encabezado-pie-2.png}}
...
\item
  \href{https://ctan.org/}{Comprehensive TeX Archive Network}. Principal
  repositorios de paquetes para TeX y LaTeX.
\item
